    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-white leading-tight mb-6">
                Editar Cliente: <span class="text-blue-600">{{ $cliente->nombre }} {{ $cliente->apellido }}</span>
            </h2>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-8 border border-gray-200 dark:border-gray-700">
                <form action="{{ route('clientes.update', $cliente) }}" method="POST">
                    @csrf
                    {{-- Directiva obligatoria en Laravel para actualizar registros --}}
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono" id="telefono" value="{{ old('telefono', $cliente->telefono) }}" placeholder="Ej. 5512345678"
                                class="w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                        ...
                        <div class="md:col-span-2 lg:col-span-3">
                            ...
                            {{-- Usamos $direccion->campo ?? '' por si en algún caso extremo el cliente no tuviera dirección registrada, no rompa la vista --}}
                            <input type="text" name="calle" id="calle" value="{{ old('calle', $direccion->calle ?? '') }}" required placeholder="Ej. Av. Hidalgo 123"
                                class="w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="manzana" id="manzana" value="{{ old('manzana', $direccion->manzana ?? '') }}" placeholder="Ej. Mz 45"
                                class="w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="lote" id="lote" value="{{ old('lote', $direccion->lote ?? '') }}" placeholder="Ej. Lt 12"
                                class="w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="colonia" id="colonia" value="{{ old('colonia', $direccion->colonia ?? '') }}"
                                class="w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150">
                        </div>
                        ...
                        <div class="md:col-span-2 lg:col-span-3">
                            ...
                            <textarea name="referencia" id="referencia" rows="2" placeholder="Ej. Casa verde de dos pisos, portón negro..."
                                class="w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150">{{ old('referencia', $direccion->referencia ?? '') }}</textarea>
                        </div>
                    </div>
