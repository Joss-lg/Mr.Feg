...
<div id="modalCrearGasto" class="fixed inset-0 z-[100] hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 transition-opacity duration-300">
    ...
    <div id="createGastoContainer" class="bg-[#F2F2F2] border border-slate-200 w-full max-w-md rounded-[1.5rem] sm:rounded-[2rem] shadow-2xl overflow-hidden transform transition-all duration-300 scale-95 opacity-0 flex flex-col max-h-[92dvh]">
        ...
        <form action="{{ route('admin.gastos.store') }}" method="POST" class="flex flex-col flex-1 min-h-0 bg-[#F2F2F2]">
            @csrf
