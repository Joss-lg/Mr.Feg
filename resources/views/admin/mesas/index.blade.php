...
@section('content')
<div class="p-3 sm:p-4 lg:p-6 max-w-[1600px] mx-auto w-full space-y-4 flex-1 flex flex-col bg-[#F2F2F2] text-[var(--text-color)] h-[calc(100vh-80px)] overflow-hidden">
